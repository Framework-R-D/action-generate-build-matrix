# Agent Instructions — action-generate-build-matrix

## Repository Purpose

Generates a dynamic build matrix for the cmake-build workflow
...
| `.github/workflows/python-check.yaml` | Python check: ruff, mypy, pytest |

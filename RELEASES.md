# Release Procedure for action-generate-build-matrix
...
gh release create "${NEXT_VERSION}" \
  ...
  --generate-notes \
  --repo Framework-R-D/action-generate-build-matrix
...
TYPE=$(gh api repos/Framework-R-D/action-generate-build-matrix/git/ref/tags/${NEXT_VERSION} \
  --jq .object.type)
if [ "$TYPE" = "tag" ]; then
  NEW_SHA=$(gh api repos/Framework-R-D/action-generate-build-matrix/git/tags/${NEW_SHA} \
    --jq .object.sha)
fi
